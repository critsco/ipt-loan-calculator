...
//gcc -o t_remove.o t_remove.c -lsqlite3 -ljansson  -lfcgi
...
int main() {
 while (FCGI_Accept() >= 0) {
    ...
    const char *sql = "DELETE FROM teachers WHERE t_id = ?";
...
//curl -X POST -H "Content-Type: application/json" -d '[{"name": "selectedRow", "value": "21100001011"}]' http://172.28.98.30:8080/test/test/cgi-bin/t_remove.o
