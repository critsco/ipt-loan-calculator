...
//gcc -o t_show.o t_show.c -lsqlite3 -ljansson  -lfcgi
...
int main() {
 while (FCGI_Accept() >= 0) {
    ...
    const char *sql = "SELECT * FROM teachers WHERE t_id > ?";
...
//curl -X POST -H "Content-Type: application/json" -d '[{"name": "uid", "value": "3"}]' http://172.28.98.30:8080/test/test/cgi-bin/t_show.o
